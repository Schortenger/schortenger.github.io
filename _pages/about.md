...
My research focuses on **compositional intelligence for robot generalization**: enabling robots to construct complex behaviors by combining reusable models, skills, and constraints rather than learning each task from scratch. I am particularly interested in different forms of composition, including **product of experts** for combining task constraints, **mixture of models** for representing multimodal behaviors, and the **sequencing of task-agnostic skills for long-horizon manipulation**. My work explores how such compositional structures can support planning and control in contact-rich robotic systems, where nonlinear dynamics, hybrid contact modes, and physical uncertainty make generalization particularly challenging. To this end, I draw on tools spanning <u>tensor networks</u>, <u>generative models</u>, <u>symbolic AI</u>, <u>optimal control</u>, and <u>learning from demonstration</u>. These ideas have been studied across a range of dexterous and long-horizon manipulation problems, including planar pushing, object reorientation, block assembly, and bimanual manipulation.
