...
I am broadly interested in planning and control for robotic systems that can physically interact with the surroundings, especially in task and motion planning and contact-rich manipulation. I am deeply interested in the underlying scientific question: how can we cope with the combinatorial complexity arising from the interplay of discrete and continuous variables? To tackle this, I have proposed several approaches by leveraging tools from symbolic AI, tensor factorization, and optimal control. These methods have been validated through several long-horizon dexterous manipulation tasks. I am also interested in addressing this challenge from a learning perspective, such as learning from demonstration.
