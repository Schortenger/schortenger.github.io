...
My research focuses on **compositional intelligence for robot generalization**: enabling robots to construct complex behaviors by combining reusable models, skills, and constraints rather than learning each task from scratch. I am particularly interested in **products of experts**, **mixtures of models**, and the **sequencing of task-agnostic skills for long-horizon manipulation**. My work combines <u>tensor networks</u>, <u>generative models</u>, <u>symbolic AI</u>, <u>optimal control</u>, and <u>learning from demonstration</u> to develop compositional approaches for planning and control in contact-rich robotic systems.
